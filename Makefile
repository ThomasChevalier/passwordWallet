...
CC=avr-gcc
UCTARGET=atmega32u4
CFLAGS= -Os -Wall -Werror -DF_CPU=12000000UL -mmcu=$(UCTARGET) -std=gnu99 -fshort-enums -ffunction-sections -fdata-sections -MMD
LDFLAGS= -mmcu=$(UCTARGET)
BDIR=build
SDIR=src
DDIR=.
ODIR=.
...
main: $(OBJS)
	...
	avr-size -C --mcu=$(UCTARGET) $(BDIR)/main
