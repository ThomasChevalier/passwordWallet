 ...
 * File created on 17-08-2017 16-36-05
*/
...
// INIT VALUE
#define DDRB_INIT_VALUE ((1 << SPI_SS_PIN_NUM) | (1 << SPI_SCK_PIN_NUM) | (1 << SPI_MOSI_PIN_NUM) | 0)
#define PORTB_INIT_VALUE ((1 << BUTTON_1_PIN_NUM) | (1 << BUTTON_2_PIN_NUM) | (1 << BUTTON_3_PIN_NUM) | (1 << BUTTON_4_PIN_NUM) | 0)

#define DDRC_INIT_VALUE ((1 << RFID_RES_PIN_NUM) | 0)
#define PORTC_INIT_VALUE ((1 << RFID_RES_PIN_NUM) | 0)

#define DDRD_INIT_VALUE ((1 << LED_PIN_NUM) | (1 << OLED_DC_PIN_NUM) | (1 << OLED_RES_PIN_NUM) | (1 << RFID_CS_PIN_NUM) | 0)
#define PORTD_INIT_VALUE ((1 << RFID_CS_PIN_NUM) | 0)

#define DDRF_INIT_VALUE ((1 << FRAM_CS_PIN_NUM) | (1 << OLED_CS_PIN_NUM) | 0)
#define PORTF_INIT_VALUE ((1 << FRAM_CS_PIN_NUM) | (1 << OLED_CS_PIN_NUM) | 0)

#define INIT_ALL_DDR DDRB = DDRB_INIT_VALUE; \
DDRC = DDRC_INIT_VALUE; \
DDRD = DDRD_INIT_VALUE; \
DDRF = DDRF_INIT_VALUE; \

#define INIT_ALL_PORT PORTB = PORTB_INIT_VALUE; \
PORTC = PORTC_INIT_VALUE; \
PORTD = PORTD_INIT_VALUE; \
PORTF = PORTF_INIT_VALUE; \
